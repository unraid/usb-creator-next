                    ...
                    RowLayout {
                        ...
                        TextField {
                            ...
                            onTextChanged: {
                                ...
                                if (enabled) {
                                    publicKeyModel.set(publicKeyItem.index, {
                                        publicKeyField: text
                                    });
                                }
                            }
                            ...
                            onEditingFinished: {
                                ...
                                publicKeyModel.set(publicKeyItem.index, {
                                    publicKeyField: contentField.text
                                });
                            }
                        }
        ...
        RowLayout {
            ImButton {
                ...
                onClicked: {
                    ...
                    publicKeyModel.append({
                        publicKeyField: root.imageWriter.getDefaultPubKey()
                    });
                }
            }
            ImButton {
    ...
    function clearAllSSHKeyErrors() {
        ...
        for (var i = 0; i < publicKeyModel.count; i++) {
            ...
            if (item && item.publicKeyField) {
                ...
                publicKeyModel.set(i, {
                    publicKeyField: item.publicKeyField
                });
            }
        }
    }
